...
var Stadia_AlidadeSmoothDark = L.tileLayer(
  "https://tiles.stadiamaps.com/tiles/alidade_smooth_dark/{z}/{x}/{y}{r}.png?api_key=564be360-7359-45b9-8659-2e5accbe6357",
  {
    maxZoom: 20,
    attribution:
...
document.getElementById("vis").addEventListener("click", () => {
  ...
  if (visibility) {
    ...
    document
      ...
      .classList.remove("header--passive");
    document
      .getElementsByClassName("header")[0]
    ...
    document
      .getElementsByClassName("home")[0]
      .classList.remove("visible-active");
...
document.addEventListener("click", function (evnt) {
  {
    if (evnt.target.id == "growing") {
      if (!paragraph.growing) {
        document
          .getElementsByClassName("about--section")[1]
          .classList.remove("section--paragraph-passive");
        document
          .getElementsByClassName("about--section")[1]
          .classList.add("section--paragraph-active");
      } else {
        document
          .getElementsByClassName("about--section")[1]
          .classList.remove("section--paragraph-active");
        document
          .getElementsByClassName("about--section")[1]
          .classList.add("section--paragraph-passive");
      }
      paragraph.growing = !paragraph.growing;
    } else if (evnt.target.id == "spray") {
      if (!paragraph.spray) {
        document
          .getElementsByClassName("about--section")[0]
          .classList.remove("section--paragraph-passive");
        document
          .getElementsByClassName("about--section")[0]
          .classList.add("section--paragraph-active");
      ...
      if (!paragraph.wheel) {
        document
          .getElementsByClassName("about--section")[2]
          .classList.remove("section--paragraph-passive");
        document
          .getElementsByClassName("about--section")[2]
          .classList.add("section--paragraph-active");
  ...
  if (!paragraph.wheel && !paragraph.spray && !paragraph.growing) {
    document
      .getElementsByClassName("about--header")[0]
      .classList.remove("h3-active");
    document
      .getElementsByClassName("about--header")[0]
      .classList.add("h3-passive");
  } else {
    document
      .getElementsByClassName("about--header")[0]
      .classList.add("h3-active");
    document
      .getElementsByClassName("about--header")[0]
      .classList.remove("h3-passive");
  }
});
